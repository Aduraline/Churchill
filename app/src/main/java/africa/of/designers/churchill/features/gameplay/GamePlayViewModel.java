...
import africa.of.designers.churchill.commons.SingleLiveEvent;
import africa.of.designers.churchill.commons.Timer;
import africa.of.designers.churchill.data.GameDataSource;
import africa.of.designers.churchill.data.WordDataSource;
import africa.of.designers.churchill.data.entity.GameDataMapper;
import africa.of.designers.churchill.model.GameData;
import africa.of.designers.churchill.model.UsedWord;
import africa.of.designers.churchill.model.Word;
...
public class GamePlayViewModel extends ViewModel {
    ...
    public void generateNewGameRound(int rowCount, int colCount) {
        if (!(mCurrentState instanceof Generating)) {
            setGameState(new Generating(rowCount, colCount, "Tàiyáng"));

            Observable.create((ObservableOnSubscribe<GameData>) emitter -> {
                List<Word> wordList = mWordDataSource.getWords();
                GameData gr = mGameDataCreator.newGameData(wordList, rowCount, colCount, "Tàiyáng");
